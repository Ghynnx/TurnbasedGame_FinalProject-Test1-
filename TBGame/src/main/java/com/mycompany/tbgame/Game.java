...
public class Game {
        ...
        while (true) {
            ...
            switch (choice) {
                case "1":
                    ...
                    break;
                case "2":
                    battle(hero, dungeon, actionHistory, questManager, sc);
                    break;
                case "3":
    ...
    // Use the static Random instance instead of passing it as a parameter
    public static void battle(Hero hero, DungeonEncounter dungeon, ActionHistory actionHistory, QuestManager questManager, Scanner sc) {
